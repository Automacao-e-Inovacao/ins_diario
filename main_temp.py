...
logging.basicConfig(filename=os.path.join(caminho_relativo, 'logs_temp.log'),
                    filemode='w',
...
try:
    ...
    from encontrar_janela import encontrar_janela
    ...
    for dia_for in range(2, 8, 1):
        dia_anterior = datetime.datetime.now() - datetime.timedelta(days=dia_for)
